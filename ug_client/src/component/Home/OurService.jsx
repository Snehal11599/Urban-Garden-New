...
<div className="card-group">
  <div className="card">
    <img className="card-img-top" src="./assets/Home/LandScape Design.jpg" alt="Card  cap"/>
  ...
  <div className="card">
    <img className="card-img-top" src="./assets/Home/Planting and removeal.jpg" alt="Card  cap"/>
    <div className="card-body">
  ...
  <div className="card">
    <img className="card-img-top" src="./assets/Home/Garden Care.jpg" alt="Card  cap"/>
    <div className="card-body">
