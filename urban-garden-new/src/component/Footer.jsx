    ...
    return (
        <div>
            <div className="card bg-dark text-white" style={{ marginTop: "100px" }}>
                <img src="/assets1/HomeImages/background.jpg" className="card-img" alt="..." />
                <div className="card-img-overlay">
                    ...
                    <div className="col-md-4">
                        <img src="/assets1/HomeImages/bg1.png" className="img-fluid rounded-start " style={{ float: "right" }} alt="..." />
                    </div>
                </div>
            </div>
